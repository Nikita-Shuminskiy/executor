...
const ConfirmationLogisticsPointModal = ({
	isOpen,
	onClose,
	onPressSave,
	chosenPaczkomat,
}: ConfirmationLogisticsPointModalProps) => {
				...
				>
					<Box flexDirection={'row'} alignItems={'center'} justifyContent={'space-between'}>
						<Text fontSize={16} fontFamily={'semiBold'}>
							{dictionary[DictionaryEnum.SaveTheSelectedLogisticsPoint]}
						</Text>
					...
					<Text fontSize={15} fontFamily={'regular'}>
						{chosenPaczkomat.point_name}
					</Text>
					<Text fontSize={15} fontFamily={'regular'}>
						{chosenPaczkomat.address}
					</Text>

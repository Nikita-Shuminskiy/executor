                ...
                <Box justifyContent={'space-between'} w={'100%'}>
                    ...
                    <Box paddingX={2} h={375} w={'100%'} alignItems={'center'} justifyContent={'space-evenly'}
                        ...
                        <Box flex={1} w={'100%'} alignItems={'center'}>
                            ...
                            <Box mt={3} w={'100%'}>
                                <Box borderRadius={16} flexDirection={'row'} justifyContent={'flex-start'}
                                     alignItems={'center'}
                                    ...
                                    <Box flexDirection={'row'} justifyContent={'flex-start'}
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={styles.link}>
                                            <Text color={colors.blue} fontFamily={'regular'}>TOC</Text>
                                        </TouchableOpacity>
                                    </Box>
                                </Box>
                        ...
                        <Box flex={1} alignItems={'center'} w={'100%'} justifyContent={'center'}>
                            <Button disabled={disBtn} onPress={onPressContinue}

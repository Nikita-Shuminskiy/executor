                    ...
                    <Box justifyContent={'space-between'} w={'100%'}>
                        <Box alignItems={'center'}>
                            <Image style={{width: '100%', position: 'relative', top: 1}} source={imgBack}/>
                            {
                                ...
                                <Text fontSize={15} fontFamily={'regular'} color={colors.red} position={'absolute'}
                                      bottom={32}>{dictionary[DictionaryEnum.ErrorGettingPermissions]}</Text>
                            }
                        </Box>
                        <Box paddingX={10} h={375} w={'100%'} alignItems={'center'} justifyContent={'space-evenly'}
                            ...
                            <Box flex={1} alignItems={'center'}>
                                <Text fontSize={28}
                                      fontFamily={'semiBold'}>{dictionary[DictionaryEnum.GivePermissions]}</Text>
                            ...
                            <Box flex={1} w={'100%'}>
                                <Button onPress={onPressGivePermission} styleContainer={styles.styleContainerBtn}
                                        title={dictionary[DictionaryEnum.GivePermissions]}
                                        colorText={colors.white}
                                        backgroundColor={errorPermission ? colors.red : colors.blue}/>
                            </Box>
                        </Box>
                    </Box>
                </Box>

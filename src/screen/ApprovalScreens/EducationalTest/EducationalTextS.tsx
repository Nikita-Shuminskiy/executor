...
const EducationalTextS = observer(({ navigation }: EducationalTextSProps) => {
	...
	const onPressNavigateChangeLang = () => {
		navigation.navigate(routerConstants.CHANGE_LANGUAGE, { exam_passed: 'not_passed' })
	}
	...
	return (
		<BaseWrapperComponent isKeyboardAwareScrollView={true}>
			...
			<Box paddingTop={10} alignItems={'center'} justifyContent={'center'}>
				<Box mb={3}>
					<TouchableOpacity onPress={onPressNavigateChangeLang}>
						<Text ml={2} fontSize={20} color={colors.blue} fontFamily={'regular'}>
							{dictionary[DictionaryEnum.ChangeLanguage]}
						</Text>
					</TouchableOpacity>
				</Box>
				<Box paddingX={4}>
				...
				<Box flex={1} w={'100%'} alignItems={'center'} mt={5} mb={5}>
					<Button
						onPress={onPressGoToExam}
						styleContainer={styles.styleContainerBtn}
						title={dictionary[DictionaryEnum.FinishReadingGoToExam]}
